...
public class Utilidades {
    ...
    public static void registrarEventoRetrofit(String type_events, String description, String token){
        String url = "http://so-unlam.net.ar/api/";

        EventoRequest request = new EventoRequest();
        request.setEnv(VariablesGlobales.env);
        ...
        Call<EventoResponse> call = service.event("Bearer " + token, request);
