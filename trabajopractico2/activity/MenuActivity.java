...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilidades.registrarEventoRetrofit("Ingreso a la aplicacion", "El usuario inicio sesion o se registro de manera exitosa", token);
    }
    ...
    protected void onResume() {
        ...
        buttonDosisUno.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Utilidades.registrarEventoRetrofit("Boton Dosis 1 Apretado", "Se ingreso al grafico de dosis 1", token);
                abrirDosisUno(v);
            }
        });
        ...
        buttonDosisDos.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Utilidades.registrarEventoRetrofit("Boton Dosis 2 Apretado", "Se ingreso al grafico de dosis 2", token);
                abrirDosisDos(v);
            }
        });
        ...
        buttonDatosGenerales.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Utilidades.registrarEventoRetrofit("Boton Datos Generales Apretado", "Se ingreso a los datos generales", token);
